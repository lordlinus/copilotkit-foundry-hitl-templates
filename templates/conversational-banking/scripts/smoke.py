...
READ_PROMPT   = "Show me my accounts and balances."
ACTION_PROMPT = "Transfer 100 from checking to savings."
STATE_FIELD   = "transfers_count"
READ_TOOL     = "list_accounts"   # used only to craft the C10 orphan history
