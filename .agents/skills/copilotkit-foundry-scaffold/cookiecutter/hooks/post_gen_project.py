...
print("    8. make smoke && make e2e   (end-to-end HITL against the real agent, run locally via")
print("                                 'azd ai agent run' — reuses the project 'make up' just")
print("                                 provisioned, no extra manual step)")
print("    9. make up-app              (deploy the bridge + frontend Container Apps via azd)")
print("   10. make verify-deployed     (proves a REAL active Foundry agent answers — required")
